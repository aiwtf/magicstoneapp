...
Return ONLY the following JSON structure.
{
  ...
  "archetype_name": "string (in {{TARGET_LANG}})",
  "archetype_description": "string (in {{TARGET_LANG}})",
  "mbti_type": "string (e.g. INFJ)",
  "enneagram_type": "string (e.g. 4w5)",
  "core_tension": "string (in {{TARGET_LANG}})",
  "narrative_phase": "string (in {{TARGET_LANG}})",
  "dimensions": {
  ...
  "soul_color": "hex_code",
  "summary": "string (A deep psychological profile in {{TARGET_LANG}})"
}
...
export const PROMPT_DICT_CONST: Record<string, any> = {
    en: {
